...
N_NORM_PARAMS = 33  # Number of normalization parameters
BEAM_ENERGIES = [180, 315, 450, 585, 720, 855, 1101, 2143]  # List of beam energies (in MeV)
...
def read_cs_data():
    ...
    data = pd.read_csv(
        "data/OG+PRadCrossSectionsData.dat", sep=" ", skiprows=1, usecols=cols.keys(), names=cols.values()
    )
