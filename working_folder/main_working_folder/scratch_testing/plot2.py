...
if __name__ == "__main__":
    ARGS = fit.parse_args()
    main(ARGS.order, ARGS.best_reg_param, "data/CrossSections.dat")
    main(ARGS.order, ARGS.best_reg_param, "data/RebinnedCrossSectionsData.dat")
    main(ARGS.order, ARGS.best_reg_param, "data/OG+PRadCrossSectionsData.dat")
    main(ARGS.order, ARGS.best_reg_param, "data/Rebinned+PRadCrossSectionsData.dat")
